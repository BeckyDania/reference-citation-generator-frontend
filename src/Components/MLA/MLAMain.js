...
import MLABook from './MLABook'
import MLAarticle from './MLAarticle'
import MLAWebsite from './MLAWebsite'
...
<Grid container spacing={3}>
		<Grid item xs={3}>
			<MLABook addSource={this.addSource}/>
		</Grid>
		<Grid item xs={3}>
			<MLAarticle addSource={this.addSource}/>
		</Grid>
		<Grid item xs={3}>
			<MLAWebsite addSource={this.addSource}/>
		</Grid>
