...
class MLAarticle extends Component {
	  ...
	  handleSubmit = (event) => {
		...
		render(props){
			...
			<div className={classes.root}>
				...
				<DialogTitle id="form-dialog-title">Website</DialogTitle>
				<DialogContentText>
				Enter the article information here
			  </DialogContentText>
			  <DialogContent>
			  <TextField
				margin="dense"
...
export default withStyles(useStyles)(MLAarticle)